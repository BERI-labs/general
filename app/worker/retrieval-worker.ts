...
const SYNONYM_MAP: Record<string, string[]> = {
  ...
  sport:        ["sports", "co-curricular", "activities", "facilities", "athletic", "athletics"],
  sports:       ["sport", "co-curricular", "activities", "facilities", "athletic", "athletics"],
  athletic:     ["sport", "sports", "co-curricular", "activities", "fitness", "facilities"],
  athletics:    ["sport", "sports", "co-curricular", "activities", "fitness", "facilities"],
  fitness:      ["sport", "sports", "gym", "facilities", "co-curricular"],
  active:       ["sport", "sports", "co-curricular", "activities", "fitness"],
  physical:     ["sport", "sports", "pe", "fitness", "co-curricular"],
  gym:          ["fitness", "sport", "sports", "facilities"],
  rugby:        ["sport", "sports", "co-curricular", "facilities", "team"],
  football:     ["sport", "sports", "co-curricular", "facilities", "team"],
  swimming:     ["sport", "sports", "co-curricular", "facilities", "pool"],
  netball:      ["sport", "sports", "co-curricular", "activities", "team"],
  cricket:      ["sport", "sports", "co-curricular", "facilities", "team"],
  tennis:       ["sport", "sports", "co-curricular", "activities"],
  team:         ["sport", "sports", "co-curricular", "activities"],
  teams:        ["sport", "sports", "co-curricular", "activities"],
...
const SECTION_SIGNALS: Record<string, Set<string>> = {
  ...
  "Co-Curricular": new Set([
    ...
    "athletic", "athletics", "fitness", "gym", "rugby", "football", "swimming",
    "netball", "cricket", "tennis", "team", "teams", "active", "physical",
  ]),
};
